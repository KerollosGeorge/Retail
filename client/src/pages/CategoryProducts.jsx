...
export const CategoryProducts = () => {
  ...
  const { products, setProducts, stockMap, updateProductStock } =
    useProductStore();
  ...
  return (
    <div className="min-h-screen">
      <Navbar />
      <div className="w-full flex flex-col justify-center py-4 px-12">
        {/* Category header */}
        {category && (
        ...
        {products?.length > 0 && (
          <div className="w-full flex flex-col items-center mb-8">
            <h1 className="w-full text-3xl font-semibold py-4 text-gray-200">
                    ...
                    <div className="px-4 pb-4 flex items-center justify-center">
                      <button
                        ...
                        onClick={async (e) => {
                          ...
                          // ✅ Always add 1 item
                          const updated = await addToCart(product._id, 1);
                          ...
                          if (
                            ...
                            updateProductStock(product._id, stock - 1);
                          }
                        }}
                        className={`${
                          stock === 0
